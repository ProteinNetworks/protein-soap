...
def makePNG(pdbRef, spectrumMax):
...
bg_color white
spectrum b, blue_red, minimum=0, maximum={1}
...
parser.add_argument("--max", default="1.0", help="the max for spectrum")
args = parser.parse_args()

makePNG(args.filename, args.max)
